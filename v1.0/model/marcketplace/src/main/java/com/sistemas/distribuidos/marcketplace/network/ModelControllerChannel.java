...
public class ModelControllerChannel extends ReceiverAdapter implements RequestHandler {

	JChannel channel;
    MessageDispatcher despacher;

    public ModelControllerChannel() {
    	// Empty constructor
    }
    ...
    **/
    public void startChannel() throws Exception {
    	...
    	this.channel.connect("ModelController"); // conecta no canal dos models
